...
export default function EditProfileScreen() {
  ...
  const [portfolioPublic, setPortfolioPublic] = useState(
  ...
  async function submit() {
    ...
    if (!/^[a-zA-Z0-9_]{3,24}$/.test(username))
      return setError("Use 3–24 letters, numbers, or underscores.");
    setError(null);
  ...
  return (
    <AuthScaffold
      eyebrow="PROFILE"
      subtitle="Keep this honest, specific, and close to the work you want to be known for."
