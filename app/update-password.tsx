...
export default function UpdatePasswordScreen() {
  ...
  return (
    <AuthScaffold subtitle="Choose something memorable and unique to this account." title="New password.">
      ...
      <FormField
        ...
        value={password}
      />
      <PrimaryButton isLoading={isSubmitting} label="Update password" onPress={submit} />
    </AuthScaffold>
  );
}
