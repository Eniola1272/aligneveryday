...
const existingResponse = await clickUp(`/list/${listId}/task?archived=false&include_closed=true`);
...
console.log(JSON.stringify({ listId, total: stories.length, created, skipped }, null, 2));
